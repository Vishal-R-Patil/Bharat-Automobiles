                    ...
                    <tbody>
                        {isAddingNew && (
                            <tr className="bg-highlight">
                                <td><span className="badge badge-good">New</span></td>
                                <td><input value={newInlineProduct.name} onChange={e => setNewInlineProduct({...newInlineProduct, name: e.target.value})} className="input-field"/></td>
                                <td>
                                    <select value={newInlineProduct.category} onChange={e => setNewInlineProduct({...newInlineProduct, category: e.target.value})} className="input-field">
                                ...
                                <td><input value={newInlineProduct.product_description} onChange={e => setNewInlineProduct({...newInlineProduct, product_description: e.target.value})} className="input-field"/></td>
                                <td><input type="number" value={newInlineProduct.price} onChange={e => setNewInlineProduct({...newInlineProduct, price: e.target.value})} className="input-field"/></td>
                                <td><input type="number" value={newInlineProduct.stock_qty} onChange={e => setNewInlineProduct({...newInlineProduct, stock_qty: e.target.value})} className="input-field"/></td>
                        ...
                        {sortedProducts.map((product, index) => (
                            <tr key={product.id}>
                                ...
                                {editingId === product.id ? (
                                    <>
                                        <td><input value={editForm.name} onChange={e => setEditForm({...editForm, name: e.target.value})} className="input-field"/></td>
                                        <td><input value={editForm.category} onChange={e => setEditForm({...editForm, category: e.target.value})} className="input-field"/></td>
                                        <td><input value={editForm.product_description} onChange={e => setEditForm({...editForm, product_description: e.target.value})} className="input-field"/></td>
                                    ...
                                    <>
                                        ...
                                        <td className="text-center">
                                            <button onClick={() => handleEditClick(product)} className="btn-icon"><EditIcon/></button>
                                            <button onClick={() => handleDeleteClick(product.id)} className="btn-icon"> <TrashIcon/></button>
                                        </td>
                                    </>
                                )}
                            </tr>

...
function Billing() {
  ...
  const handleNameChange = (index, value) => {
    ...
    if (existingProduct) {
      ...
      const qty =
        Number(updatedCart[index].quantity) > 0
  ...
  const handleCheckoutClick = () => {
    const invalidItems = cartItems.filter(
      (item) => item.product_id === null && item.name !== "",
    );
    if (invalidItems.length > 0)
      return alert(`Error: Unknown product in cart!`);
    ...
    <div>
      ...
      <div className="no-print dashboard-container">
        <header className="dashboard-header">
          ...
          <button
            className="btn btn-backToDashboard"
        ...
        <div className="billing-grid">
          ...
          <div className="card bg-highlight m-0">
            ...
            <div
              className="flex-between mb-3 font-bold"
            ...
            <div style={{ display: "flex", justifyContent: "center" }}>
              <button
                ...
                style={{ padding: "15px", fontSize: "1em", width: "80%" }}
              >
                Complete Sale
              </button>
            </div>
          ...
          <div className="modal-overlay">
            <div className="modal-content">
              ...
              <p className="text-muted mt-3 mb-4">
                Complete sale for{" "}
                <strong className="text-main" style={{ fontSize: "1.2em" }}>
                  ₹{finalAmount}
                </strong>
                ?
              </p>
              <div className="modal-actions">
                ...
                <button
                  ...
                  className="btn btn-outline text-danger w-100 mt-2"
                  style={{ padding: "12px", borderColor: "var(--danger)" }}
                >
                  ❌ Cancel
                </button>
              </div>
